            ...
            <div className="flex min-h-full items-center justify-center p-4">
              ...
              >
                ...
                <div className="overflow-y-auto max-h-[90vh]">
                  {/* Project Image */}
                  <div className="relative h-64 md:h-80 w-full bg-linear-to-br from-blue-900 to-slate-700">
                    <Image
                      src={project.image}
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-3">
                        {project.technologies.map((tech, index) => (
                          <motion.span
                            key={tech}
                            className="px-4 py-2 bg-linear-to-r from-blue-50 to-slate-50 dark:from-blue-900/20 dark:to-slate-800/20 text-blue-900 dark:text-blue-400 rounded-lg border border-blue-200 dark:border-blue-800 font-medium text-sm"
