  ...
  return (
    ...
    >
      ...
      >
        ...
        <Link
          href={`/${locale}`}
          className="text-2xl font-bold bg-linear-to-r from-blue-900 via-slate-700 to-slate-600 dark:from-blue-400 dark:via-slate-400 dark:to-slate-300 bg-clip-text text-transparent hover:opcity-80 transition-opacity focus:outline-none focus:ring-2 focus:ring-blue-900 focus:ring-offset-2 rounded-md px-2"
        ...
        <ul className="hidden md:flex items-center space-x-1 rtl:space-x-reverse">
          {navLinks.map((item) => (
            <li key={item.href}>
              <Link
                href={item.href}
                className="px-4 py-2 text-slate-900 dark:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-800"
              >
                {t(item.labelKey)}
              </Link>
            </li>
          ...
          >
            <div className="p-6 flex flex-col h-full">
              ...
              <div className="flex items-center justify-between mb-8">
                <h2 className="text-xl font-bold bg-linear-to-r from-blue-900 via-slate-700 to-slate-600 dark:from-blue-400 dark:via-slate-400 dark:to-slate-300 bg-clip-text text-transparent">
                  Menu
                </h2>
                <button
                  onClick={() => setIsMobileMenuOpen(false)}
                    ...
                    <li key={item.href}>
                      <Link
                        ...
                        className={`block px-6 py-4 rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-900 focus:ring-offset-2 text-lg font-medium ${
                          isActive(item.href)
                            ? "bg-linear-to-r from-blue-900 to-slate-700 text-white shadow-lg"
