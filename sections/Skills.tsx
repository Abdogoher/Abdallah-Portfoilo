  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-16">
        <h2
          id="skills-heading"
          className="text-3xl md:text-4xl font-bold mb-4 bg-linear-to-r from-blue-900 via-slate-700 to-slate-600 dark:from-blue-400 dark:via-slate-400 dark:to-slate-300 bg-clip-text text-transparent leading-tight"
        >
          {t("title")}
        </h2>
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-8">
                <div
                  className={`p-3 rounded-xl bg-linear-to-br ${category.color} shadow-lg`}
                  aria-hidden="true"
                >
