...
import { Clock, Github, Linkedin, Mail, MapPin, MessageSquare, Phone, Send, User } from "lucide-react";
interface FormData {
  name: string;
  email: string;
  subject: string;
  ...
  const socialLinks = [
    {
      ...
      href: "https://github.com/Abdogoher",
      color: "hover:bg-gray-800",
    },
    {
      icon: Linkedin,
      label: t("social.connectOnLinkedin"),
      href: "https://www.linkedin.com/in/abdallah-goher-6b0a93259/",
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full bg-white dark:bg-slate-700 text-gray-900 dark:text-white pl-10 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-900 focus:ring-offset-2 transition-all duration-200 ${
                      errors.name
            ...
            {contactInfo.map((info, index) => {
              ...
              const content = (
                <div className="flex items-center p-6 bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-gray-200 dark:border-slate-700 hover:shadow-xl transition-all duration-200">
                  <div
                    className={`p-3 rounded-lg bg-linear-to-r ${info.color} text-white mx-3 shrink-0`}
                  >
