...
interface ProjectsProbs {
    locale : string
}
const Projects = ({ locale }: ProjectsProbs) => {
  ...
  return (
    ...
    >
      <div className="text-center mb-12">
        <h2
          id="projects-heading"
          className="text-3xl md:text-4xl font-bold mb-4 bg-linear-to-r from-blue-900 via-slate-700 to-slate-600 dark:from-blue-400 dark:via-slate-400 dark:to-slate-300 bg-clip-text text-transparent leading-tight pb-2"
          style={{
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
        {featuredProjects.map((project, index) => (
          ...
          >
            {/* project image  */}
            <div className="relative h-48 md:h-48 aspect-video md:aspect-auto w-full overflow-hidden bg-linear-to-br from-blue-900 to-slate-700">
              <Image
                src={project.image}
            ...
            <div className="p-6">
              ...
              >
                {project.technologies.map((tech) => (
                  <span
                    key={tech}
                    className="px-3 py-1 text-xs font-medium bg-linear-to-r from-slate-50 to-blue-50 dark:from-slate-700 dark:to-slate-600 text-gray-800 dark:text-gray-200 rounded-lg border border-gray-200 dark:border-slate-600"
                    role="listitem"
                  >
                    {tech}
                  </span>
      ...
      <div className="text-center">
        <Link
          ...
          className="inline-flex items-center gap-2 px-8 py-3 bg-linear-to-r from-blue-900 to-slate-700 text-white rounded-lg hover:from-blue-950 hover:to-slate-800 shadow-lg hover:shadow-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-900 focus:ring-offset-2 font-medium"
        >
          {t("viewAllProjects")}
